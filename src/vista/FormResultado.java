...
public class FormResultado extends javax.swing.JFrame {
    ...
    public FormResultado(TipoImagen jugadorGanador, Tablero tablero) {
        ...
        if (jugadorGanador==TipoImagen.EQUIS) {
            ...
            lblNombre.setText(Form3EnLinea.nombreJugadorEquis.getText());
        }
        else if (jugadorGanador==TipoImagen.CIRCULO) {
            imgIzquierda.setRuta(Ruta.JUGADORCIRCULO);
            imgDerecha.setRuta(Ruta.CIRCULO);
            lblNombre.setText(Form3EnLinea.nombreJugadorCirculo.getText());
        }
    ...
    private void initComponents() {
        ...
        imgIzquierda.setBounds(90, 100, 40, 40);
        ...
        lblNombre.setFont(new java.awt.Font("Monospaced", 1, 20)); // NOI18N
        ...
        lblNombre.setBounds(0, 100, 420, 38);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelFondo, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
