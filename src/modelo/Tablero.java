...
public class Tablero extends JPanel{
    ...
    public void crearCuadrosInternos(){
        ...
        for (int i = 0; i < 3; i++) {
            x=margen;
            for (int j = 0; j < 3; j++) {
                Cuadro cuadro = new Cuadro(anchoCI,altoCI, colorCI);
    ...
    public void reiniciarTablero(TipoImagen ganador){
        ...
        if (ganador==TipoImagen.EQUIS) {
            int puntajeNuevo = Integer.parseInt(Form3EnLinea.puntajeEquis.getText())+1;
            Form3EnLinea.puntajeEquis.setText(String.valueOf(puntajeNuevo));
        } else if (ganador==TipoImagen.CIRCULO) {
            int puntajeNuevo = Integer.parseInt(Form3EnLinea.puntajeCirculo.getText())+1;
            Form3EnLinea.puntajeCirculo.setText(String.valueOf(puntajeNuevo));
        }
    ...
    public void cambiarEstilos(TipoImagen jugadorAct){
        if(jugadorAct==TipoImagen.CIRCULO){
            Form3EnLinea.imgJugadorEquis.setRuta(Ruta.JUGADORAUXILLAR);
            Form3EnLinea.imgJugadorEquis.repaint();
            Form3EnLinea.nombreJugadorEquis.setForeground(new Color(240,240,240,100));
            
            Form3EnLinea.imgJugadorCirculo.setRuta(Ruta.JUGADORCIRCULO);
            Form3EnLinea.imgJugadorCirculo.repaint();
            Form3EnLinea.nombreJugadorCirculo.setForeground(new Color(255,200,255));
        }else if(jugadorAct==TipoImagen.EQUIS){
            Form3EnLinea.imgJugadorCirculo.setRuta(Ruta.JUGADORAUXILLAR);
            Form3EnLinea.imgJugadorCirculo.repaint();
            Form3EnLinea.nombreJugadorCirculo.setForeground(new Color(240,240,240,100));
            
            Form3EnLinea.imgJugadorEquis.setRuta(Ruta.JUGADOREQUIS);
            Form3EnLinea.imgJugadorEquis.repaint();
            Form3EnLinea.nombreJugadorEquis.setForeground(new Color(180,232,255));
        }
    }
